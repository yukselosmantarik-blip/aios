...
export const MobileStickyCTADescriptor = {
  "id": "component:mobilestickycta",
  "name": "MobileStickyCTA",
  "category": "conversion",
  "purpose": "Mobile sticky order/contact CTA",
  "propsSchema": {
    "title": "string",
    "description": "string",
...
export type MobileStickyCTADescriptor = typeof MobileStickyCTADescriptor;
