...
import WebsiteBriefWizard from "@/components/website-briefs/WebsiteBriefWizard";
...
type AgentWizardPageProps = {
  params: Promise<{ agentId: string }>;
};

export default async function AgentWebsiteWizardPage({
  params,
